          ...
          {toc?.map(tocItem => {
            ...
            return (
              <a
                ...
                className={`${activeSection === id && 'border-blue-500 text-blue-500 font-bold'} border-l pl-4 block hover:text-blue-500 border-lduration-300 transform font-light dark:text-gray-300
