  ...
  return (
    <div id='top-nav' className={'fixed top-0 w-full z-20 ' + className}>
      ...
      <div className='flex justify-center border-b dark:border-black items-center w-full h-16 bg-white dark:bg-hexo-black-gray'>
        <div className='px-5 max-w-screen-fit w-full flex gap-x-3 justify-between items-center'>
          {/* 左侧*/}
          <div className='flex'>
            <LogoBar {...props} />
              ...
              <>
                <SignedOut>
                  <SignInButton mode='modal'>
                    <button className='bg-blue-500 hover:bg-blue-600 text-white rounded-lg px-3 py-2'>
